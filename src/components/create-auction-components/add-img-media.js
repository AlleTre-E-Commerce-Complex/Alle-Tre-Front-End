...
const AddImgMedia = () => {
  ...
  console.log("====================================");
  return (
    <div className={fileOne && "flex gap-x-4"}>
      <div className={fileTwo && " gap-x-4 flex"}>
        <div className="flex gap-x-4">
          {fileOne ? (
            <div className="relative">
              <div className="w-[299px] h-[189px] hover:bg-gradient-to-t hover:from-[#25252562] absolute z-30 group">
          ...
          {fileThree ? (
            ...
            <div
              className={`${fileTwo ? "" : "hidden"} ${fileThree && "hidden"}`}
            >
              <div className="cursor-pointer">
                <FileUploader
                  className="hidden"
          ...
          {fileFour ? (
            ...
            <div
              className={`${fileThree ? "" : "hidden"} ${fileFour && "hidden"}`}
            >
              <div className="cursor-pointer">
                <FileUploader
                  className="hidden"
