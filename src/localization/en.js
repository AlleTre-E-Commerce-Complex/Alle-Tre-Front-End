...
const en = {
  ...
  [localizationKeys.dontHaveAnAccount]: "DON'T HAVE AN ACCOUNT?",
  [localizationKeys.keepMeSignedIn]: "KEEP ME SIGNED IN",
  [localizationKeys.alreadyHaveAnAccount]: "ALREADY HAVE AN ACCOUNT?",
  [localizationKeys.sendVerification]: "SEND VERIFICATION",
  [localizationKeys.backToLogin]: "BACK TO LOGIN",
  [localizationKeys.resetPassword]: "Reset Password",
  [localizationKeys.sellYourAsset]: "Sell Your Asset",
  [localizationKeys.liveAuctions]: "Live Auctions",
  [localizationKeys.fixedPrice]: "Fixed Price",
  [localizationKeys.letBuyersBidForTheBestPrice]:
    "Let buyers bid for the best price",
  [localizationKeys.sellInstantlyAtYourSetPrice]:
    "Sell instantly at your set price",
  [localizationKeys.chooseTheBestWayToSellYourItem]:
    "Choose the best way to list your item",
  ...
  [localizationKeys.eMailAddress]: "E-mail Address",
  ...
  [localizationKeys.joinThousandsDiscerning]:
    "Join thousands of discerning collectors who trust 3arbon for acquiring extraordinary pieces from around the world.",
  [localizationKeys.darkMode]: "Dark Mode",
  [localizationKeys.privateAccess]: "Private Access",
  ...
  [localizationKeys.howCanWeHelpYou]: "How can we help you today?",
  [localizationKeys.reportBug]: "Report a Bug",
  [localizationKeys.foundBugDescription]:
    "Found something not working correctly? Let us know so we can fix it.",
  [localizationKeys.contactSupport]: "Contact Support",
  [localizationKeys.contactSupportDescription]:
    "Need help with your account or a transaction? Our team is here to help.",
  ...
  [localizationKeys.favourites]: "FAVOURITES",
  ...
  [localizationKeys.activeListings]: "Active Listings",
  [localizationKeys.itemsSold]: "Items Sold",
  ...
  [localizationKeys.connectUs]: "Connect Us",
  ...
  [localizationKeys.accessBlocked]: "Access Blocked Or Deleted",
  ...
  [localizationKeys.popular]: "Popular",
  [localizationKeys.newestToOldest]: "Newest to Oldest",
  [localizationKeys.oldestToNewest]: "Oldest to Newest",
  [localizationKeys.priceHighestToLowest]: "Price Highest to Lowest",
  [localizationKeys.priceLowestToHighest]: "Price Lowest to Highest",
  [localizationKeys.yearHighestToLowest]: "Year Highest to Lowest",
  [localizationKeys.yearLowestToHighest]: "Year Lowest to Highest",
  [localizationKeys.kilometersHighestToLowest]: "Kilometers Highest to Lowest",
  [localizationKeys.kilometersLowestToHighest]: "Kilometers Lowest to Highest",
  [localizationKeys.saved]: "Saved",
  ...
  [localizationKeys.assetSuccessfullySold]: "Asset Successfully Sold",
  [localizationKeys.assetAuthenticityVerified]: "Asset Authenticity Verified",
  [localizationKeys.viewProduct]: "View Product",
  [localizationKeys.viewReceipt]: "View Receipt",
  ...
  [localizationKeys.typeAMessage]: "Type a message...",
  [localizationKeys.solved]: "Solved",
  [localizationKeys.allYourBugs]: "All reported bugs",
  [localizationKeys.bugStatus]: "Status",
  [localizationKeys.synchronizing]: "Synchronizing...",
  [localizationKeys.chronology]: "Chronology",
  [localizationKeys.awaitingResponse]: "Awaiting Response",
  [localizationKeys.you]: "You",
  [localizationKeys.supportLabel]: "Support",
  [localizationKeys.established]: "Established",
  [localizationKeys.provideEmailAddress]: "Provide Email Address",
  [localizationKeys.correspondenceEmail]: "CORRESPONDENCE EMAIL",
  [localizationKeys.issueNarrative]: "ISSUE NARRATIVE",
  [localizationKeys.detailTheAnomaly]: "Detail the anomaly...",
  [localizationKeys.attachMedia]: "ATTACH MEDIA",
  [localizationKeys.visuals]: "VISUALS",
  [localizationKeys.processing]: "Processing...",
  [localizationKeys.Report]: "Report",
  [localizationKeys.retreat]: "RETREAT",
  ...
  [localizationKeys.comments]: "Comments",
  [localizationKeys.postComment]: "Post Comment",
  [localizationKeys.commentPlaceholder]: "Add a comment...",
  [localizationKeys.noCommentsYet]: "No comments yet. Be the first to comment!",
