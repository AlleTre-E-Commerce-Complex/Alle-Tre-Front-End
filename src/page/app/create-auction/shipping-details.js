    ...
    <div className="mt-44 animate-in ">
      ...
      <div className=" max-w-[1366px] mx-auto ">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mx-auto pt-6">
          <LocationDetailsCard
            AddressLable={"Address1"}
            Address={"9-noblaa street behend sultan mosco"}
            Country={"Alexandria"}
            City={"Egypt"}
            PostalCode={"216522"}
          />
      ...
      <AddLocationModel open={open} setOpen={setOpen} TextButton={"Add"} />
    </div>
  );
};
...
export const LocationDetailsCard = ({
  ...
  return (
    <div
      className={`${
        false ? "border-primary" : "border-gray-med"
      } border-[1px] rounded-lg h-[120px] w-full p-5`}
    >
