    ...
    parag: {
      en: (
        <div>
          ...
          <li>
            User : Anyone who accesses the 3arbon website, whether for the purpose
            of viewing, selling, purchasing, or buying without limitation.
          </li>
          <li>
            Buyer : Anyone who offers a commodity or service on the site,
            whether by way of listing or direct sale.
          </li>
          <li>
          ...
          <li>
            Buyer : Anyone who submits a financial offer to purchase the
            offered item.
          </li>
          <li>
            purchase : The buyer on the platform after the end of the
            offer period.
          </li>
          <li>
            Second purchase : The person with the second purchase on the platform
            after the end of the offer period.
          </li>
          <li>
            Offer Period : The period during which the buyer offers the good or
      ...
      ar: (
        <div>
          <li>الموقع : موقع www.3arbon.com</li>
          <li>
            المالك : شركة عربون ذ م م شركة ذات مسؤولية محدودة مقرها رأس الخيمة
            – دولة الامارات العربية المتحدة.
          </li>
          <li>
            المستخدم: كل من يدخل الى موقع عربون سواء لغرض المشاهدة أو البيع أو
            الشراء أو الشراء دون حصر.
          </li>
          <li>
            العارض: كل من يقوم بعرض سلعة أو خدمة على الموقع سواء بطريقة البيع
            أو البيع المباشر.
          </li>
          <li>
            المعروض: السلعة أو الخدمة التي يتم عرضها على الموقع سواء بطريقة
            البيع أو البيع المباشر.
          </li>
          <li>المشتري: كل من يقوم بتقديم عرض مالي لشراء المعروض.</li>
          <li>اعلى عرض: صاحب الطلب في البيع بعد انتهاء فترة العرض.</li>
          <li>ثاني عرض: صاحب ثاني الطلب في البيع بعد انتهاء فترة العرض.</li>
          <li>
            فترة العرض: الفترة التي يعرض فيها العارض السلعة أو الخدمة في البيع.
          </li>
        </div>
      ),
    },
    ...
    parag: {
      en: (
        <li>
          ...
          order to display it on the electronic listing method. to the highest
      ...
      ar: (
        <li>
          ...
          وذلك للعرض على طريقة البيع العلني الاليكتروني، يقوم من يرغب بالشراء
          على المعروض وذلك وفقاً لشروط الموقع وذلك بهدف نقل ملكية المعروض من
          العارض إلى صاحب الطلب في البيع.
        </li>
      ),
    },
  },
      ...
      en: (
        <div>
          <li>
            ...
            follow-up in all categories, but if the viewer wants to view or purchase
          ...
          <li>
            purchasing: The user enters the purchasing process after paying the
            insurance specified by the site to purchase on the commodity.
          </li>
          <li>
            the sale shall be awarded to the owner of the purchase
          ...
          <li>
            In the event that the buyer fails to transfer the ownership of the
            offered item to the buyer, or if there is a material defect in the
            offered item, a fine will be applied to the buyer, and the item
            will be removed from the list and the buyer's account will be
      ...
      ar: (
        <div>
          <li>
            ...
            التصنيفات، ولكن في حالة رغبة المشاهد عرض السلعة أوشرائها
            يتوجب عليه التسجيل.
          </li>
          <li>
          ...
          <li>بعد اكتمال عملية التسجيل يحق للمستخدم العرض أو الشراء.</li>
          <li>
          ...
          <li>
            الشراء: يدخل المستخدم عملية الشراء وذلك بعد أن يقوم بدفع التأمين
            المحدد من الموقع للشراء على السلعة.
          </li>
          <li>
            يرسو البيع على صاحب الطلب تم تقديمه على السلعة، وبعد الموافقة
      ...
      en: (
        <div>
          ...
          <li>
            ...
            a fine will be imposed on any person who does not apurchasee by the terms
            of the sale. The value of this financial fine will be shared in a
          ...
          <li>
            ...
            listing, and in the event If he fails to comply with the terms of
            the sale, a fine will be imposed to be deducted from the
            insurance value.
          </li>
          <li>
            The buyer can purchase on any of the commodities offered on the site,
      ...
      ar: (
        <div>
          ...
          <li>
            ...
            أي شخص غير ملتزم بشروط البيع، يتم اقتسام قيمة هذه الغرامة المالية
          ...
          <li>
            ...
            المبلغ التأمين للتأكد التزامه بشروط البيع، وفي حال عدم التزامه
            بشروط البيع سيتم فرض غرامة مالية تخصم من قيمة التأمين.
          </li>
          <li>
            يمكن للمشتري الشراء على أي من السلع المعروضه بالموقع بشرط التزامه
            بشروط التأمين، وفي حال رسو البيع عليه وتخلفه عن السداد سيتم فرض
  ...
  return (
    <div className="py-2.5 mx-4">
      <motion.div
        ...
        className={`overflow-hidden border-primary-light dark:border-primary border-[1px] rounded-lg px-8 cursor-pointer`}
        initial={{ height: "44px" }}
      ...
      >
        ...
        <p className="text-gray-med font-normal text-primary dark:text-white pt-3 pb-10 ">
          {parag}
        </p>
      </motion.div>
    </div>
