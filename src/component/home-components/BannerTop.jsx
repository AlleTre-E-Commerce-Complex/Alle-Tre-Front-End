...
import BannerTopImage2 from '../../assets/images/BannerTop2.png';
import BannerTopImage3 from '../../assets/images/BannerTop3.png';
...
const BannerTop = () => {
    ...
    const autoSlideInterval = 6000; // Slide every 3 seconds
        ...
        <div className="relative w-full md:w-[76%] mt-10 mx-auto">
            <div className="relative h-56 overflow-hidden rounded-lg md:h-[29rem]">
                {images.map((image, index) => {
                    ...
                    let position = isActive ? 'translate-x-0' : direction === 'right' ? '-translate-x-full' : 'translate-x-full';

                    return (
                        <div
                            key={index}
                            className={`absolute inset-0 transition-transform duration-700 ease-in-out ${position} ${isActive ? 'z-20' : 'z-10'}`}
                        >
                            <img
                                src={image}
                ...
                <>
                    ...
                    >
                        <svg className="w-4 h-4 text-gray-800" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M7.707 14.707a1 1 0 01-1.414-1.414L9.586 10 6.293 6.707a1 1 0 111.414-1.414l4 4a1 1 0 010 1.414l-4 4z" clipRule="evenodd" />
                        </svg>
                    </button>
                    <button
                        type="button"
                    ...
                    >
                        <svg className="w-4 h-4 text-gray-800" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M12.293 14.707a1 1 0 001.414-1.414L10.414 10l3.293-3.293a1 1 0 10-1.414-1.414l-4 4a1 1 0 000 1.414l4 4z" clipRule="evenodd" />
                        </svg>
                    </button>
                </>
            )}
