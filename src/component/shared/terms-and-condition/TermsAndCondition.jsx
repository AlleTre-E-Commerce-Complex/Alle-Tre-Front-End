...
const TermAndConditionData = [
  {
    ...
    parag: {
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            "عربون" مجمع للتعامل الإلكتروني ذ م م نرحب بكم في منصة “عربون”،
            حيث نقدم خدمات البيع الإلكتروني. باستخدامك للمنصة، فإنك توافق على
      ...
      en: (
        <div className="mx-2 sm:mx-4">
          ...
          <li>
            ...
            financial data - purchases. Participation in previous sales - any
          ...
          <li>
            ...
            list a product or to view the exhibits.
          </li>
          <li>
            <span className="font-bold sm:font-extrabold block sm:inline mb-1 sm:mb-0">
              Exhibit/ Exhibits :
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            ...
            موقع عربون مجمع للتعامل الإلكتروني ذ م م ش ش و .
          </li>
          <li>
            <span className="font-bold sm:font-extrabold block sm:inline mb-1 sm:mb-0">
              البيانات الشخصية :
            ...
            البيانات المالية – المشتريات – المشاركات فى عرضات سابقة ) أية
          ...
          <li>
            ...
            عرض او للاطلاع على المعروضات .
          </li>
          <li>
            <span className="font-bold sm:font-extrabold block sm:inline mb-1 sm:mb-0">
              المعروض / المعروضات:
            </span>
            ه.يقصد بها جميع السلع الموجودة على موقع عربون مجمع للتعامل
            الإلكتروني ذ م م ش ش و و و التطبيق الإلكتروني المعروضة للبيع و
            الشراء عليها على سبيل المثال لا الحصر ( الهواتف الذكية - و الأجهزة
          ...
          <li>
            ...
            شبه حكومية أو الخاصة بكافة أنواعها مالكة المعروضات علي موقع عربون
          ...
          <li>
            ...
            يقصد به الشخص الذي يرغب في شراء أياً من المعروضات على موقع عربون
          ...
          <li>
            ...
            يقصد به الشخص الذي قام بالشراء على السلع المعروضة بأعلي سعر و تم
            ترسيه البيع عليه و المسموح له بشراء السلع من خلال المنصة المعروضة
            من قبل المستخدم على المنصة دون تدخل من قبل عربون مجمع للتعامل
            الإلكتروني .
          </li>
          <li>
            <span className="font-bold sm:font-extrabold block sm:inline mb-1 sm:mb-0">
      ...
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            ...
            immediately notify 3ARBON of any not licensed use of your account
            or any security breach. 3ARBON Platform Management reserves the
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            ...
            حديثة أو غير كاملة)، أو كان لدى عربون مجمع للتعامل الالكتروني
            أسباب مقنعة للاشتباه في هذه المعلومات بأنها غير صحيحة أو غير دقيقة
            أو غير حديثة أو غير كاملة، فإن منصة عربون لديها الحق في تعليق أو
            ...
            من حسابك في نهاية كل جلسة. أنت توافق على إبلاغ عربون على الفور بأي
            استخدام غير مصرح به لحسابك أو أي خرق أمني. تحتفظ إدارة منصة عربون
  ...
  },
  {
    ...
    parag: {
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            The "3ARBON" platform is an electronic market that provides users
            with the ability to participate in sales for electronic products.
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            منصة “عربون” هي سوق إلكتروني توفر للمستخدمين إمكانية المشاركة في
            البيعات الخاصة بالمنتجات الإلكترونية. تقدم المنصة للمستخدمين فرص
  ...
  },
  {
    ...
    parag: {
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            3ARBON" grants you a limited license to use the platform for
  ...
  },
  {
    ...
    parag: {
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            ...
            you grant "3ARBON" a non-exclusive global license to use this
            content within the framework of providing the service. "3ARBON"
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            يبقى المحتوى الذي تقدمه على المنصة ملكًا لك، ولكنك تمنح “عربون”
            ترخيصًا عالميًا غير حصري لاستخدام هذا المحتوى في إطار تقديم الخدمة.
            تحتفظ “عربون” بحق إزالة أو تعديل أي محتوى يخالف القوانين أو سياسات
            المنصة.
          </li>
        </div>
      ),
        ...
        <div>
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              "3ARBON" acts as an intermediary to facilitate listing
              operations between sellers and buyers. The platform is not a
            ...
            <li className="mt-3 sm:mt-4">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-2">
                ...
                <li>
                  ...
                  solve any technical problems or inquiries related to sales.
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div className="rtl text-right px-2 sm:px-4">
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              تعمل [عربون] كوسيط لتسهيل عمليات البيع بين البائعين والمشترين.
            ...
            <li className="mt-3 sm:mt-4">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-2">
                ...
                <li>
                  الأضرار الناتجة عن استخدام المنصة أو المشاركة في البيعات.
                </li>
            ...
            <li className="mt-3 sm:mt-4">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-2">
                ...
                <li>
                  ...
                  تقنية أو استفسارات تتعلق بالبيعات.
                </li>
              </ul>
            </li>
          </ul>
  ...
  {
    title: { en: "8- listing Integrity", ar: "٨- نزاهة البيع:" },
    parag: {
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            ...
            measures, which include canceling the sale, confiscating the
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            تلتزم منصة عربون بضمان نزاهة وشفافية البيعات. لذا، يُمنع تمامًا
            على البائع سواء بشكل مباشر أو غير مباشر، المشاركة كمشتري في البيع
            ...
            تشمل إلغاء البيع، مصادرة مبلغ التأمين، وحظر الحسابات المتورطة،
        ...
        <div>
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              on the platform and acts as an intermediary to display the goods
            ...
            <li className="mt-3 sm:mt-4">
              <span className="font-bold">Buyer's responsibility:</span>: The
              buyer or buyer is solely responsible for reviewing all data and
              information related to the condition of the item before purchasing or
              purchasing.
            </li>
            <li className="mt-3 sm:mt-4">
              <span className="font-bold"></span>The buyer shall bear all costs
              related to the inspection and registration of the
              vehicle/property/item. 3arbon platform and the seller shall not
        ...
        <div>
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              شركة عربون لا تقدم أي ضمانات للمعروضات في البيع وتعمل كوسيط
            ...
            <li className="mt-3 sm:mt-4">
              <span className="font-bold">مسؤولية المشتري</span>: المشتري أو
              المشتري هو المسؤول الوحيد عن مراجعة جميع البيانات والمعلومات
              المتعلقة بحالة المعروض قبل الشراء أو الشراء.
            </li>
            <li className="mt-3 sm:mt-4">
              ...
              تتحمل منصة 3arbon أو البائع أي مسؤولية قانونية أو مالية بشأن هذه
      ...
      en: (
        <div>
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-1">
                <li>
                  Both the seller and the buyer must pay the insurance amount
          ...
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-1">
                <li>
                  ...
                  <ul className="list-disc ml-3 sm:ml-6">
                    <li>
                      In the event of cancellation of the sale before its
                      expiration:
                    </li>
                    <ul className="list-disc ml-3 sm:ml-6">
                      <li>
                        If there are no buyers, the insurance amount will be
                        refunded in full.
                      </li>
                      <li>
                        If there are buyers, The insurance amount will be
                        confiscated in full and The buyer will be
                        compensated with 30% of the insurance amount, and the
                        rest will go to the platform.
                      </li>
                    </ul>
                    <li>After the end of the sale:</li>
                    <ul className="list-disc ml-3 sm:ml-6">
                      <li>
                      ...
                      <li>
                        the sale winner will be compensated with 50% of the
                ...
                <li>
                  ...
                  <ul className="list-disc ml-3 sm:ml-6">
                    <li>
                      The buyer is obligated to pay the full amounts within the
                      specified period and for the buyer or buyer, the
                      insurance percentage will be displayed separately
                      according to each offer..
                    </li>
                    <li>
                      In the event that the buyer does not comply with paying
                      the sale fees, the insurance amount will be confiscated
            ...
            <li className="mt-3 sm:mt-4">
              <span className="font-semibold">Platform Charges:</span> 3ARBON
            ...
            <li className="mt-3 sm:mt-4">
              <span className="font-semibold">Deposit the purchase Amount:</span>
              In the event that the buyer wins, they must deposit the purchase
              amount into 3ARBON’s bank account within 72 hours from the date
              of the sale fees.
            </li>
          </ul> */}
        </div>
        ...
        <div>
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-1">
                <li>
                  يجب على البائع والمشتري دفع مبلغ التأمين بالطريقة المحددة من
                  قبل المنصة، مثل:
                </li>
                <ul className="list-disc ml-3 sm:ml-6">
                  <li>بطاقة ائتمان</li>
          ...
          <ul className="list-decimal ml-3 sm:ml-6">
            <li className="mt-2 text-sm sm:text-base">
              ...
              <ul className="list-disc ml-3 sm:ml-6 mt-1">
                <li>
                  ...
                  <ul className="list-disc ml-3 sm:ml-6">
                    <li>في حالة إلغاء البيع قبل انتهاء موعده:</li>
                    <ul className="list-disc ml-3 sm:ml-6">
                      <li>
                        إذا لم يكن هناك مشترون، سيتم استرداد مبلغ التأمين
                        بالكامل.
                      </li>
                      <li>
                        إذا كان هناك مشترون، سيتم مصادرة مبلغ التأمين بالكامل
                        وسيتم تعويض أعلى مشتري بنسبة 30% من مبلغ التأمين،
                        والباقي يذهب إلى المنصة.
                      </li>
                    </ul>
                    <li>بعد انتهاء البيع:</li>
                    <ul className="list-disc ml-3 sm:ml-6">
                      <li>
                        اذا لم يكن هناك أي مشترين في البيع سيتم رد مبلغ
                        التـأمين كاملاً
                      </li>
                      <li>
                        سيتم تعويض الفائز بالبيع بنسبة 50% من مبلغ التأمين،
                ...
                <li>
                  <span className="font-semibold">
                    بالنسبة للمشتري او المشتري
                  </span>
                  <ul className="list-disc ml-3 sm:ml-6">
                    <li>
                      يلتزم المشتري بسداد كامل المبالغ خلال المدة المحددة و سيتم
                      عرض نسبة التآأمين بشكل منفصل على حسب كل معروض.
                    </li>
                    <li>
                      في حالة عدم التزام المشتري بسداد مبلغ رسو البيع سيتم
            ...
            <li className="mt-3 sm:mt-4">
              ...
              3arbon نسبة 0.5% فقط على كل عملية ناجحة داخل المنصة، عن كل مستخدم
              .
            </li>
            <li className="mt-3 sm:mt-4">
              <span className="font-semibold">المسؤولية القانونية:</span> لا
              تعتبر شركة عربون غير مسؤولة قانونًا عن هذه المخالفات، ويمكن
              اتخاذ إجراءات قانونية أمام محاكم الدولة.
            </li>
            <li className="mt-3 sm:mt-4">
              <span className="font-semibold">إيداع مبلغ المعروض:</span>
              في حال فوز المشتري، يجب عليه إيداع مبلغ الشراء في الحساب البنكي
              في حال فوز المشتري، يجب عليه إيداع مبلغ المعروض في الحساب البنكي
              الخاص بشركة عربون خلال 72 ساعة من تاريخ رسو البيع .
            </li>
          </ul> */}
        </div>
      ),
  ...
  //           secure transactions, 3arbon imposes a security deposit on certain
  //           categories of products listed for listing. The deposit amount is
  ...
  //                 products listed on the platform (such as smartphones,
  ...
  //                 on the platform if the product value is 5000 AED or less.
  //               </li>
  //               <li>
  ...
  //               of the sale, in accordance with the terms outlined in the
  ...
  //           <p>
  //             3arbon reserves the right to modify the security deposit amounts
  ...
  //           آمن، تفرض منصة 3arbon مبلغ تأمين على بعض الفئات من المنتجات التي
  //           يتم عرضها للبيع من خلال البيعات الإلكترونية. يتم تحديد مبلغ التأمين
  ...
  //                 الإلكترونية المعروضة في البيع (مثل الهواتف الذكية، أجهزة
  ...
  //                 للبيع في البيع، مع حد أدنى قدره 5000 درهم إماراتي.
  //               </li>
  //               <li>
  ...
  //                 البيع في حال كانت قيمة المنتج 5000 درهم أو أقل.
  //               </li>
  //               <li>
  ...
  //               حال تم إنهاء البيع بنجاح ووفقًا للشروط التي يتم تحديدها في
  ...
  //           <p>
  //             يحق لمنصة 3arbon تعديل مبالغ التأمين في أي وقت حسب تقديرها، ويجب
  ...
  // },
  {
    ...
    parag: {
      en: (
        <div className="mx-2 sm:mx-4">
          <li>
            By accepting these terms, you agree to compensate 3ARBON for any
      ...
      ar: (
        <div className="mx-2 sm:mx-4">
          <li>
            بقبولك لتلك الشروط فأنك توافقلى تعويض “عربون” عن أي مطالبات أو
      ...
      en: (
        <div className="mx-2 sm:mx-4">
          ...
          <span>
            ...
            3ARBON is not responsible for the content of these links or any
            damages that may result from their use.
          </span>
          <div className="mt-3 sm:mt-4">
            <span className="text-lg font-bold text-gray-verydark">13-</span>
            <span>
              Protection of intellectual property rights 3ARBON respects
        ...
        <div className="mx-2 sm:mx-4">
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              ...
              “عربون” مسؤولية محتوى هذه الروابط أو أي أضرار قد تنتج عن
              استخدامها.
            </span>
          </div>
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              حماية حقوق الملكية الفكرية تحترم “عربون” حقوق الملكية الفكرية
        ...
        <div className="ml-4 -mt-5">
          ...
          <ul className="list-disc ml-3 sm:ml-6 ">
            <li>
              ...
              <ul className="list-disc mt-1 ml-6">
                <li>
                  أي نزاع ينشأ بين كلاً من المورد (البائع ) و المشتري ( المشتري
                  ) تقوم منصة عربون مجمع للتعامل الألكتروني بالتحكيم فيما
                  ...
                  تسوية نهائياً قابل للنفاذ فور اعتماده من منصة عربون مجمع
                  للتعامل الالكتروني .
                </li>
                <li>
                  يكون عدد المحكمين (1) وتكون عربون مجمع للتعامل الالكتروني هى
      ...
      en: (
        <div className="ml-4 -mt-8">
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              Amendments and Notifications: 3ARBON reserves the right to amend
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              Termination of Service: 3ARBON reserves the right to suspend or
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              ...
              receive notices from 3ARBON via email or via notices on the
              site. Any notice issued by 3ARBON shall be considered an
              official notice.
            </span>
          </div>
          <div className="mt-3 sm:mt-4">
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              ...
              that you agree to these terms before starting to use the 3ARBON
              platform.
            </span>
          </div>
        </div>
      ...
      ar: (
        <div className="ml-4 -mt-8">
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              الامتثال لضريبة القيمة المضافة: تؤكد منصة عربون أن جميع
              ...
              <ul className="mt-2 list-disc list-inside">
                ...
                <li>
                  تعمل منصة عربون كوسيط إلكتروني لتسهيل عمليات البيعات بين
                ...
                <li>
                  تخلي منصة عربون مسؤوليتها بشكل كامل عن أي إخفاق من قِبل
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              التعديلات والإخطارات تحتفظ “عربون” بحقها في تعديل الشروط
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              إنهاء الخدمة تحتفظ “عربون” بالحق في تعليق أو إنهاء حساب
          ...
          <div className="mt-3 sm:mt-4">
            ...
            <span>
              ...
              الإشعارات من “عربون” عبر البريد الإلكتروني أو عن طريق الإشعارات
              على الموقع. يُعتبر أي إشعار صادر عن “عربون” بمثابة إشعار رسمي.
            </span>
          </div>
          <div className="mt-3 sm:mt-4">
            <span className="text-lg font-bold text-gray-verydark">١٩- </span>
            <span>
              - مقر الشركة “عربون” هي من ممتلكات [عربون مجمع للتعامل
              الالكتروني].
            </span>
          </div>
          <div className="mt-3 sm:mt-4">
    ...
    parag: {
      en: (
        <div className="ml-4 -mt-5">
          ...
          <span>3arbon Platform Participation and Advertisement Policy</span>
          <p className="mt-2">
            Please note that posts or advertisements containing any of the
            following are not permitted in any of the 3arbon Platform sections:
          </p>
          <ul className="list-disc ml-3 sm:ml-6">
            <li>
            ...
            <li className="mt-3">
              ...
              <ul className="list-disc mt-1 ml-6">
                ...
                <li>
                  ...
                  conditions of the "3arbon" platform, and any violation may
      ...
      ar: (
        <div className="ml-4 -mt-5">
          ...
          <span>سياسة المشاركات والإعلانات في منصة "3arbon"</span>
          <p className="mt-2">
            نرجو ملاحظة أنه لا يسمح بالمشاركات أو الإعلانات التي تحتوي على أي
            مما يلي في أي من أقسام منصة "3arbon":
          </p>
          <ul className="list-disc ml-3 sm:ml-6">
            <li>
            ...
            <li className="mt-3">
              ...
              <ul className="list-disc mt-1 ml-6">
                ...
                <li>
                  يجب أن يلتزم الإعلان بجميع شروط وأحكام منصة "3arbon"، وأي
...
const TermsAndConditionsModal = ({ data, isFooter }) => {
  ...
  return (
    <div className={`mt-4 mx-1 flex justify-start ${isArabic} `}>
      ...
      {isModalOpen && (
        <div
          className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center z-[9999] overflow-visible animate-in fade-in transition-all duration-300"
          role="dialog"
          onClick={closeModal}
        >
          <div
            className="border-slate-200 dark:border-slate-800 border-[1px] border-solid bg-white dark:bg-[#111827] rounded-3xl shadow-2xl w-11/12 max-w-lg overflow-hidden z-[10000] animate-in scale-in transition-all duration-300"
          ...
          >
            <div className="p-6 text-sm">
              <div className="flex justify-between items-center mb-2">
                ...
                <button
                  className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500 hover:text-red-600 transition-colors"
                  onClick={closeModal}
                >
                  <IoClose size={24} />
                </button>
              </div>
              <div className="overflow-y-auto max-h-[60vh] mt-6 pr-4 custom-scrollbar scroll-smooth">
                {data.map((e, index) => (
                  <div key={index}>
                    <h1 className="text-slate-900 dark:text-slate-100 font-bold text-lg mb-2">
                      {e?.title[lang]}
                    </h1>
                    <div className="text-slate-600 dark:text-slate-300 font-normal text-base leading-relaxed mb-8">
                      {e?.parag[lang]}
                    </div>
                  </div>
                ))}
            ...
            <div className="p-6 border-t border-slate-100 dark:border-slate-800 flex justify-end bg-slate-50/50 dark:bg-[#111827]">
              {Footer ? (
                <button
