  ...
  return (
    <div className={`mt-4 mx-1 flex justify-start ${isArabic} `}>
      ...
      {isModalOpen && (
        ...
        >
          <div
            className="border-primary border-2 border-solid bg-white dark:bg-primary rounded-2xl shadow-2xl w-11/12 max-w-lg overflow-hidden z-[10000]"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6 text-sm">
              <div className="flex justify-between items-center">
                <h2 className="text-primary dark:text-white text-xl font-bold">
                  {selectedContent[localizationKeys.termsAndCondition]}
                </h2>
                <button
            ...
            <div className="p-6 border-t flex justify-end bg-gray-50 dark:bg-primary">
              {Footer ? (
                <button
